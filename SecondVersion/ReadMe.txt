...
LinkedList.c: This file includes the linked list implementation
LinkedList.h: This file includes the functions declaration of LinkedList.c functions 
...
To run the program type ./traffic "file.txt" e.g. "./traffic game_1.txt"
